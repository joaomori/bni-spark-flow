DROP FUNCTION IF EXISTS public.submit_candidate_qr(UUID, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
...
DECLARE
  ...
  clean_cpf TEXT := NULLIF(BTRIM(p_cpf), '');
  clean_cnpj TEXT := NULLIF(BTRIM(p_cnpj), '');
  clean_razao_social TEXT := NULLIF(BTRIM(p_razao_social), '');
...
GRANT EXECUTE ON FUNCTION public.submit_candidate_qr(UUID, DATE, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO anon, authenticated;